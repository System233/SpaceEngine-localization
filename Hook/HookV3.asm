...
SpaceEngine.exe+21759D - 74 2A                 - je label2175C9
SpaceEngine.exe+21759F - 8B 87 D0000000        - mov eax,[edi+000000D0];字号
...
SpaceEngine.exe+2175C7 - EB 3E                 - jmp label217607
                                        label2175C9:
SpaceEngine.exe+2175C9 - 0F28 C1               - movaps xmm0,xmm1
SpaceEngine.exe+2175CC - E8 4FD8E1FF           - call [call_34E20]
SpaceEngine.exe+2175D1 - 8B 87 D0000000        - mov eax,[edi+000000D0];字号
...
SpaceEngine.exe+2175FA - E8 21D8E1FF           - call [call_34E20]
...
SpaceEngine.exe+21761D - B9 E090D200           - mov ecx,[dword_4F90E0] { [00000566] }
...
SpaceEngine.exe+217669 - 0F1F 80 00000000      - ;nop [eax+00000000];填充指令 <<<<===更新跳转地址
...
SpaceEngine.exe+217677 - 2B CA                 - sub ecx,[ebp+08];sub ecx,ebx;取得下标
SpaceEngine.exe+217679 - 0FB6 D0               - ;movzx edx,al
SpaceEngine.exe+21767C - 89 54 24 2C           - mov [esp+2C],edx;当前字符
...
SpaceEngine.exe+217693 - 8B 47 24              - mov eax,[edi+24];取得字号
...
SpaceEngine.exe+2176E3 - C7 87 D0000000 00000000 - mov [edi+000000D0],00000000 { 0 };字号
...
SpaceEngine.exe+21770D - C7 87 D0000000 01000000 - mov [edi+000000D0],00000001 { 1 };字号
SpaceEngine.exe+217717 - 8B 87 D0000000        - mov eax,[edi+000000D0];字号
SpaceEngine.exe+21771D - C1 E0 04              - shl eax,04 { 4 } ;<<-???????????????
SpaceEngine.exe+217720 - 0F10 84 38 E4180000   - movups xmm0,[eax+edi+000018E4]
SpaceEngine.exe+217728 - 0F11 87 94000000      - movups [edi+00000094],xmm0;控制纹理
...
SpaceEngine.exe+217758 - C7 87 D0000000 00000000 - mov [edi+000000D0],00000000 { 0 };字号
...
SpaceEngine.exe+21777C - C7 87 D0000000 02000000 - mov [edi+000000D0],00000002 { 2 };字号
...
SpaceEngine.exe+2177A8 - 83 BF D0000000 00     - cmp dword ptr [edi+000000D0],00 { 0 };字号
...
SpaceEngine.exe+2177D2 - C7 87 D0000000 02000000 - mov [edi+000000D0],00000002 { 2 };字号
...
SpaceEngine.exe+2177EA - C7 87 D4000000 00000042 - mov [edi+000000D4],42000000 ;{ 32.00 }显示高度
SpaceEngine.exe+2177F4 - C7 07 00001042        - mov [edi],42100000 ;{ 36.00 }显示宽度
...
SpaceEngine.exe+217817 - C7 47 10 0000803F     - mov [edi+10],3F800000 ;{ 1.00 }显示宽度比例
SpaceEngine.exe+21781E - C7 47 14 0000803F     - mov [edi+14],3F800000 ;{ 1.00 }显示高度比例
...
SpaceEngine.exe+217831 - E8 BAEEFFFF           - call call_2166F0
...
SpaceEngine.exe+2178A9 - E8 725BF9FF           - call call_1AD420
SpaceEngine.exe+2178AE - 8B 74 24 24           - mov esi,[esp+24]
SpaceEngine.exe+2178B2 - 83 C6 06              - add esi,06 { 6 }
SpaceEngine.exe+2178B5 - E9 65060000           - jmp label217F1F
...
SpaceEngine.exe+2178E9 - E9 31060000           - jmp label217F1F
...
SpaceEngine.exe+217947 - E9 EB050000           - jmp loope
...
SpaceEngine.exe+21795D - E9 D5050000           - jmp loope
...
SpaceEngine.exe+2179C0 - 8B 87 D0000000        - ;mov eax,[edi+000000D0];字号
...
SpaceEngine.exe+2179DE - F3 0F10 AC 87 D8000000  - ;movss xmm5,[edi+eax*4+000000D8];显示宽度
...
SpaceEngine.exe+2179F2 - 74 0A                 - je label2179FE
SpaceEngine.exe+2179F4 - 83 E8 01              - sub eax,01 { 1 }
SpaceEngine.exe+2179F7 - 74 09                 - je label217A02
SpaceEngine.exe+2179F9 - 83 E8 01              - sub eax,01 { 1 }
SpaceEngine.exe+2179FC - 75 10                 - jne label217A0E
                                            label2179FE:
...
SpaceEngine.exe+217A0C - EB 06                 - jmp label217A14:
                                            label217A0E:
...
SpaceEngine.exe+217A57 - E8 C459F9FF           - call [call_1AD420]
...
SpaceEngine.exe+217A6E - E8 6D55F9FF           - call [call_1ACFE0]
...
SpaceEngine.exe+217A7D - E8 9E59F9FF           - call [call_1AD420]
...
SpaceEngine.exe+217AA2 - 8B 54 24 2C           - ;mov edx,[esp+2C];ch 移除
                         66 0f 1f 00             nop [eax]
                                            label217AA6:
SpaceEngine.exe+217AA6 - 8B 47 24              - mov eax,[edi+24]
SpaceEngine.exe+217AA9 - 83 E8 00              - sub eax,00 { 0 }
SpaceEngine.exe+217AAC - 74 38                 - je label217AE6
SpaceEngine.exe+217AAE - 83 E8 01              - sub eax,01 { 1 }
SpaceEngine.exe+217AB1 - 74 1E                 - je label217AD1
SpaceEngine.exe+217AB3 - 83 E8 01              - sub eax,01 { 1 }
SpaceEngine.exe+217AB6 - 75 52                 - jne label217B0A
...
SpaceEngine.exe+217ACF - EB 3F                 - jmp label217B10
                                            label217AD1
...
SpaceEngine.exe+217AE4 - EB 2A                 - jmp label217B10
                                            label217AE6:
...
SpaceEngine.exe+217B08 - EB 06                 - jmp label217B10
                                            label217B0A:
SpaceEngine.exe+217B0A - F3 0F10 54 24 20      - movss xmm2,[esp+20]
                                            label217B10:
SpaceEngine.exe+217B10 - 8B 8F D0000000        - ;mov ecx,[edi+000000D0];;字号
SpaceEngine.exe+217B1D - F3 0F10 8C 8F D8180000 ; - movss xmm1,[edi+ecx*4+000018D8];单位字进 1/纹理宽度
...
SpaceEngine.exe+217B26 - 8A 4C 24 0F           - ;mov cx,[esi];mov cl,[esp+0F] <<====重写此处
                                                  ...
                                                  movzx ecx,dl
                                                  movd xmm0,ecx
                                                  cvtdq2ps xmm0,xmm0;坐标X
                                                  movzx ecx,dh
                                                  movd xmm7,ecx;坐标Y
                                                  shr edx,10
                                                  movsx ecx,dl
                                                  movd xmm4,ecx
                                                  cvtdq2ps xmm4,xmm4;字偏:纹理
                                                  movsx eax,dh//mov eax,10
                                                  movd xmm3,eax
                                                  cvtdq2ps xmm3,xmm3;字宽:纹理
                                                  push [edi+000000D0]
...
;问题:edx将作为返回值寄存器
;方案:
;1.改edx为ebx,范围大,call过程可能修改edx
;2.备份edx,指令长


SpaceEngine.exe+21CB30 - 55                    - push ebp { 字符显示-预算
 }
...
SpaceEngine.exe+21CB3C - 8B 75 08              - mov esi,[ebp+08] { 取得参数
 }
...
SpaceEngine.exe+21CDA7 - 66 0F1F 84 00 00000000  - nop [eax+eax+00000000];浪费
                                    label21CDB0:;跳转表 0F 
...
SpaceEngine.exe+21CE25 - F3 0F10 84 87 D8000000  - movss xmm0,[edi+eax*4+000000D8];取宽
...
SpaceEngine.exe+21CDB0;DEF->21CDA7 修正
